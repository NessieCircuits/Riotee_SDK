...
Your application may change the default size of the memory that is retained across power failures as well as the stack size by definining `RIOTEE_RAM_RETAINED_SIZE` and `RIOTEE_STACK_SIZE` in the Makefile.
